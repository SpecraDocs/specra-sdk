...
/**
 * Client component that handles mobile sidebar state and rendering.
 * This is a standalone component that doesn't wrap Server Component children.
 */
export function MobileSidebarWrapper({ header, docs, version, config, activeTabGroup }: MobileSidebarWrapperProps) {
  const [sidebarOpen, setSidebarOpen] = useState(false)
  const toggleSidebar = () => setSidebarOpen(!sidebarOpen)
  const closeSidebar = () => setSidebarOpen(false)

  // Clone header and pass onMenuClick prop
  ...
  return (
    <>
      {/* Render header with menu toggle */}
      {headerWithProps}
